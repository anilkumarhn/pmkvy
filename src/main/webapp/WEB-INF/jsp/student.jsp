						...
						<section id="section-underline-1">
							...
							<form:form>
								  <div class="panel panel-default table-responsive">
									<form:label path="" align="left">Branch Name :Rajajinagar </form:label>
									<form:label path="" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sector Name :Agriculture Sector Skill Council of India </form:label>
					              	<form:label path="" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Batch Name : Batch1001 </form:label>
					        	  </div>  
							</form:form>	
...
<table>
 <tr> <td> Candidate ID : </td><td><input type="text"  name="candidateID" id="candidateID" /><br/></td></tr>
 <tr> <td> Candidate Name : </td><td> <input type="text" name="candidateName" id="candidateName" /><br/></td></tr>
<tr> <td>  Enrollment No :  </td><td><input type="text" name="enrollmentNo" id="enrollmentNo" /><br/></td></tr>
<tr> <td>  Contact No : </td><td> <input type="text" name="contactNo" id="contactNo" /><br/></td></tr>
<tr> <td>  Email ID : </td><td> <input type="text" name="emailID" id="emailID" /><br/></td></tr>
<tr> <td>  Address : </td><td> <input type="text" name="address" id="address" /><br/></td></tr>
 <tr> <td> Aadhar Number  : </td><td> <input type="text" name="aadharNo" id="aadharNo" /><br/></td></tr>
<tr> <td>  Aadhar Number Validated : </td><td> <input type="text" name="aadharValidated" id="aadharValidated" /><br/></td></tr>
</table>
  <input type="submit" value="Send" />
  <span id="cls_f1">X</span>
